...
public class NoDiffuseMirror : MonoBehaviour
{
    ...
    public void OnWillRenderObject()
    {
        ...
        Camera cam = XMLEngine.GameEngine.Logic.Global.UICamera3D;
        ...
        if(_material.HasProperty("_Ref") )
            _material.SetTexture( "_Ref", m_ReflectionTexture );
        if (refRate != -1 && _material.HasProperty("_RefRate"))
            _material.SetFloat("_RefRate", refRate);
        if (refY != -1 && _material.HasProperty("_Y"))
            _material.SetFloat("_Y", refY);
    ...
    void OnDisable()
    {
        ...
        if (m_ReflectionCameras != null)
        {
            ...
            {
                if (kvp.Value != null && kvp.Value is Camera)
