...
public class GPUSkinningPlayerMono : MonoBehaviour
{
    ...
    public AnimationManager AnimationMgr = null;
    ...
    public void Init()
    {
        ...
        if (anim != null && mesh != null && mtrl != null && textureRawData != null)
        {
            ...
            player.AnimationMgr = AnimationMgr;
            if (anim != null && anim.clips != null && anim.clips.Length > 0)
            {
                player.CrossFade(anim.clips[Mathf.Clamp(defaultPlayingClipIndex, 0, anim.clips.Length)].name,0,GPUSkinningWrapMode.Loop);
            }
        }
    }
